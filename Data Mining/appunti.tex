...
\fbox{\includegraphics[width=.8\textwidth, height=.5\textheight, keepaspectratio]{different-probabilistic-method}}
\end{center}
...
In questo caso si ha una variabile dipendente continua Y e una variabile indipendente a valori in $\Re$ X. La funzione che sivuole approssimare è rappresentata dal valore atteso condizionato: $f^*(x) = E[Y | X = x] \; \forall x \in \Re$
\end{document}
